...
class EstimateDetailsVC: UIViewController {
    ...
    func createInvoiceAsHTML() {
        ...
        let productsDict = products.map({ [$0.name ?? "": "\(($0.productSalePrice ?? 0.0) * Double($0.quantity ?? 0))"] })
