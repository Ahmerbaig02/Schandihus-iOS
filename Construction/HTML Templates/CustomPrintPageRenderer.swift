...
class CustomPrintPageRenderer: UIPrintPageRenderer {
    ...
    override func drawHeaderForPage(at pageIndex: Int, in headerRect: CGRect) {
        ...
        let textAttributes: [NSAttributedStringKey: Any] = [NSAttributedStringKey.font: font!, NSAttributedStringKey.foregroundColor: UIColor(red: 243.0/255, green: 82.0/255.0, blue: 30.0/255.0, alpha: 1.0), NSAttributedStringKey.kern: 7.5]
